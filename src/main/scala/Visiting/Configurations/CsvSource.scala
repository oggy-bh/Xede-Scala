...
case class CsvSource(delimiter: String, hasHeader: Boolean, encoding: String = "UTF-8", skipLines: Option[Int] = None, headerColumns: Option[Seq[String]] = None) extends SourceConfig {
